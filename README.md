# Projeto de Interação Humano-Computador (IHC)  - Equipe 16
...
**Título do projeto de IHC:** Identificação de melhores momentos em partidas de futebol utilizando sistemas híbridos de visão computacional
