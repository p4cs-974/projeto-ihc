...
| Funcionalidade | Como é realizada | Evidência/print                            | Observação de IHC |
| -------------- | ---------------- | ------------------------------------------ | ----------------- |
| Identificar e classificar objetos em vídeos      | O usuário seleciona um vídeo e um algorítmo de visão computacional realiza a identificação e classificação dos objetos na tela | ![Detecção de Objetos](projeto-ihc/assets/02_concorrencia/wsc-sports/wsc-objects.jpeg) | O site não nos dá uma preview do processo para realizar essa análise, mas a interface que mostra os objetos na tela destaca e classifica os objetos na tela de forma muito sólida, com bounding boxes e tags contrastantes e fáceis de serem lidas e um índice de objetos identificados        |
