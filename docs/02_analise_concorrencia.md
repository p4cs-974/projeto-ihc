...
| Sony Vegas               | ferramenta cotidiana | Editar manualmente vídeos                                                  | [?] Incluído em uma lista preliminar, sem evidência adicional           | não analisar; os padrões de editores não lineares já estão cobertos por Premiere Pro, DaVinci Resolve, CapCut e Final Cut Pro |

Se uma hipótese da Entrega 1 for confirmada ou refutada durante esta análise, atualize `H01`, `H02`... em [`../RASTREABILIDADE.md`](../RASTREABILIDADE.md).

## 1. Público-alvo desta análise

O público-alvo proposto é formado por profissionais responsáveis pelo corte e pela produção de vídeos de melhores momentos de partidas de futebol, como editores de vídeo esportivo [H03 e H27]. O contexto escolhido é a pós-produção de partidas encerradas [H12]. Nesse fluxo, o profissional enviaria gravações, acompanharia o processamento e acessaria os cortes e metadados gerados [H25 e H28]. Empresas de mídia esportiva, ligas, emissoras, produtoras e clubes são possíveis stakeholders [H04 e H20]. O uso em computadores e a familiaridade com softwares de edição ainda são hipóteses [H17] e deverão ser investigados com usuários.
...
**Link oficial:** [Adobe Premiere](https://www.adobe.com/br/products/premiere.html)  
**Data de acesso:** 03/09/2026

#### Contexto e proposta

O Premiere Pro é um concorrente indireto: não detecta melhores momentos como objetivo central, mas permite executar manualmente o que nosso projeto pretende encurtar — importar gravações, localizar acontecimentos, marcar intervalos, montar cortes e exportar. A análise se relaciona a H01, H09 e H11 da [Entrega 1](./01_conhecendo_o_problema.md), sobre o custo de percorrer gravações extensas, e a H17, sobre a familiaridade dos editores com player, biblioteca, marcadores e linha do tempo.

#### Funcionalidades relevantes

| Funcionalidade          | Como é realizada                                                                     | Evidência/print                                                                                                         | Observação de IHC                                                                                                          |
| ----------------------- | ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| Importação e biblioteca | O usuário seleciona arquivos e os adiciona ao painel do projeto.                     | ![Importação](../assets/02_concorrencia/premiere-pro/abrir%20video.png)                                                 | O seletor do sistema é familiar. Nomes e miniaturas apoiam reconhecimento, mas projetos grandes exigem organização manual. |
| Pré-visualização        | O monitor de origem exibe o clipe; o monitor do programa mostra a sequência.         | ![Pré-visualização](../assets/02_concorrencia/premiere-pro/preview%20scene.png)                                         | Preserva a diferença entre fonte e resultado, embora exija compreender clipe e sequência.                                  |
| Linha do tempo          | Vídeos e áudios são arrastados para pistas; o eixo horizontal representa tempo.      | ![Linha do tempo](../assets/02_concorrencia/premiere-pro/timeline.png)                                                  | Ordem e duração ficam visíveis, mas pistas e botões aumentam a carga cognitiva.                                            |
| Corte e ajuste          | Razor divide o clipe; ripple, roll, slip e slide fazem ajustes diferentes.           | ![Corte](../assets/02_concorrencia/premiere-pro/cortar%20video.png)                                                     | O cursor oferece feedback, mas ícones próximos ocultam consequências. Devemos expor início, fim, duração e desfazer.       |
| Marcadores              | Pontos ou intervalos recebem comentário, cor e duração e aparecem no painel Markers. | [Documentação oficial](https://helpx.adobe.com/premiere/desktop/organize-media/apply-labeling/overview-of-markers.html) | Liga uma anotação à coordenada temporal sem cortar o vídeo; é uma boa referência para eventos detectados.                  |
| Exportação              | A tela reúne destino, nome, formato e resumo antes da renderização.                  | [Recursos do Premiere](https://www.adobe.com/products/premiere/features.html)                                           | Antecipar propriedades reduz erros; nosso produto precisa mostrar duração, formato, tamanho e momentos incluídos.          |

#### Evidências de interface

![Janela de seleção de mídia do Premiere](../assets/02_concorrencia/premiere-pro/abrir%20video.png)

_Figura 1. Entrada de mídia pelo seletor de arquivos. Captura local de Giovanni, 03/09/2026._

![Premiere com painel de mídia, player e linha do tempo](../assets/02_concorrencia/premiere-pro/timeline.png)

_Figura 2. Espaço de trabalho com mídia, player e pistas. Captura local de Giovanni, 03/09/2026._

![Divisão de um clipe na linha do tempo](../assets/02_concorrencia/premiere-pro/cortar%20video.png)

_Figura 3. Corte em um ponto temporal. Captura local de Giovanni, 03/09/2026._

#### Experiência do usuário e opiniões

A Adobe permite rearranjar, redimensionar e salvar painéis em espaços de trabalho. Isso favorece especialistas, mas transfere ao usuário a configuração do ambiente. O [guia oficial](https://helpx.adobe.com/premiere/desktop/get-started/tour-the-workspace/what-are-workspaces.html) inclui tutoriais na tela inicial. O [TechRadar](https://www.techradar.com/reviews/adobe-premiere-pro-2022) destaca flexibilidade e amplitude, mas aponta complexidade e assinatura como custos. É opinião especializada, não teste com nosso público.

#### Padrões e tendências percebidos

- Biblioteca, player e linha do tempo preservam a relação entre origem, prévia e resultado.
- Miniaturas, formas de onda, timecode e marcadores evitam depender apenas da reprodução linear.
- Arraste, menus e atalhos coexistem para diferentes níveis de experiência.
- Precisão vem acompanhada de muitos painéis e modos; nosso projeto não precisa reproduzir um editor completo.
- Marcadores ligados ao tempo são mais pertinentes ao projeto que uma linha do tempo multipista.

#### Pontos positivos, limitações e lições

| Ponto                           | Evidência                                           | Implicação para nosso projeto                                               |
| ------------------------------- | --------------------------------------------------- | --------------------------------------------------------------------------- |
| Contexto verificável            | Player, playhead e timecode mostram o quadro exato. | Abrir cada resultado com contexto anterior e posterior, instante e duração. |
| Marcadores estruturam a revisão | Pontos e intervalos recebem tipo e comentário.      | Mostrar evento, tempo, confiança e acesso ao original.                      |
| Feedback imediato               | Cortes atualizam player e linha do tempo.           | Atualizar prévia e duração ao ajustar limites e oferecer desfazer.          |
| Flexibilidade cobra aprendizado | Painéis, pistas e trims atendem fluxos distintos.   | Manter o fluxo guiado: envio, processamento, revisão e download.            |
| Organização é manual            | Pastas, nomes e metadados dependem do editor.       | Preencher automaticamente partida, origem, evento e horário.                |
| Exportação antecipa o resultado | A tela resume arquivo e configurações.              | Mostrar o que será baixado e estados como preparando, pronto e erro.        |

### Análise C02 — DaVinci Resolve

**Autor(a):** Giovanni Chahin Morassi — 22.123.025-3  
**Tipo:** concorrente indireto / ferramenta cotidiana  
**Link oficial:** [DaVinci Resolve](https://www.blackmagicdesign.com/products/davinciresolve)  
**Data de acesso:** 03/09/2026

#### Contexto e proposta

O DaVinci Resolve reúne gestão de mídia, edição, cor, efeitos, áudio e entrega em páginas especializadas. Media, Cut, Edit e Deliver mostram maneiras de preparar arquivos, percorrer gravações longas, selecionar intervalos, revisar e gerar resultados. Esta é uma análise documental de páginas e imagens oficiais, não um teste controlado.

#### Funcionalidades relevantes

| Funcionalidade         | Como é realizada                                                                           | Evidência/print                                                                 | Observação de IHC                                                                                 |
| ---------------------- | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| Importação e metadados | Media importa arquivos, organiza bins e edita metadados; Smart Bins agrupam por critérios. | ![Media](../assets/02_concorrencia/davinci-resolve/01-pagina-media.jpg)         | Miniaturas e atributos apoiam escala. Devemos preencher dados e usar vocabulário do futebol.      |
| Cut Page               | Media Pool, viewer, ferramentas e duas visões temporais ficam na mesma tela.               | ![Cut](../assets/02_concorrencia/davinci-resolve/02-pagina-cut.jpg)             | Reduz trocas de tela, mas mantém comandos demais. A lição é reunir resultados, player e contexto. |
| Source Tape            | Mostra clipes de uma pasta como sequência contínua.                                        | ![Source Tape](../assets/02_concorrencia/davinci-resolve/03-source-tape.jpg)    | Evita abrir itens um a um; limites e origem ainda precisam ser explícitos.                        |
| Linha do tempo dupla   | Uma faixa mostra tudo e outra amplia o ponto atual.                                        | ![Linha dupla](../assets/02_concorrencia/davinci-resolve/04-duas-timelines.jpg) | Visão global e detalhe evitam perda de posição em gravações longas.                               |
| Edição precisa         | Edit usa pistas, monitores e trims para inserir, dividir e aparar.                         | ![Edit](../assets/02_concorrencia/davinci-resolve/05-pagina-edit.jpg)           | É familiar a profissionais, mas excessiva para validar cortes; controles de início e fim bastam.  |
| Exportação e fila      | Deliver separa configurações, fila e andamento da renderização.                            | [Página oficial](https://www.blackmagicdesign.com/products/davinciresolve)      | Torna espera observável e permite acompanhar trabalhos demorados.                                 |

#### Evidências de interface

![Página Media com biblioteca, player e metadados](../assets/02_concorrencia/davinci-resolve/01-pagina-media.jpg)

_Figura 4. Preparação de arquivos. Fonte: [Blackmagic Design, Edit](https://www.blackmagicdesign.com/products/davinciresolve/edit), acesso em 03/09/2026._

![Página Cut com Media Pool, viewer e linhas do tempo](../assets/02_concorrencia/davinci-resolve/02-pagina-cut.jpg)

_Figura 5. Edição rápida. Fonte: [Blackmagic Design, Cut](https://www.blackmagicdesign.com/products/davinciresolve/cut), acesso em 03/09/2026._

![Source Tape exibindo vários clipes continuamente](../assets/02_concorrencia/davinci-resolve/03-source-tape.jpg)

_Figura 6. Triagem contínua. Fonte: [Blackmagic Design, Cut](https://www.blackmagicdesign.com/products/davinciresolve/cut), acesso em 03/09/2026._

![Visão global e detalhada da linha do tempo](../assets/02_concorrencia/davinci-resolve/04-duas-timelines.jpg)

_Figura 7. Contexto global acima e detalhe abaixo. Fonte: [Blackmagic Design, Cut](https://www.blackmagicdesign.com/products/davinciresolve/cut), acesso em 03/09/2026._

![Página Edit com biblioteca, monitores e pistas](../assets/02_concorrencia/davinci-resolve/05-pagina-edit.jpg)

_Figura 8. Edição precisa. Fonte: [Blackmagic Design, Edit](https://www.blackmagicdesign.com/products/davinciresolve/edit), acesso em 03/09/2026._

#### Experiência do usuário e opiniões

A [documentação da Cut Page](https://www.blackmagicdesign.com/products/davinciresolve/cut) reconhece que sua organização pode confundir editores experientes, mas permite alternar entre Cut e Edit. Isso cria progressão entre seleção rápida e controle completo. O [TechRadar](https://www.techradar.com/pro/software-services/davinci-resolve-21-2026-video-editing-software-review) considera Cut mais acessível e Edit mais versátil. No [G2](https://www.g2.com/products/davinci-resolve/reviews), usuários elogiam recursos profissionais e a versão gratuita, mas citam curva de aprendizagem, navegação e hardware. São opiniões públicas, não entrevistas da equipe.

#### Padrões e tendências percebidos

- Páginas dividem o fluxo por objetivo, mas o usuário precisa reconhecer onde está.
- Miniaturas, bins e metadados permitem reconhecimento visual e filtros.
- Cut combina visão global e detalhe, útil para partidas longas com poucos eventos.
- Source Tape favorece triagem contínua; Edit preserva controle fino.
- Trabalhos em fila mantêm estados consultáveis.
- Caminhos rápido e avançado revelam detalhes somente quando necessários.

#### Pontos positivos, limitações e lições

| Ponto                        | Evidência                                              | Implicação para nosso projeto                                                    |
| ---------------------------- | ------------------------------------------------------ | -------------------------------------------------------------------------------- |
| Visão global e detalhe       | Cut mostra tudo e a região do playhead.                | Usar barra da partida com eventos e player do trecho selecionado.                |
| Triagem contínua             | Source Tape percorre vários clipes como uma faixa.     | Navegar resultados em sequência, preservando origem e limites.                   |
| Organização automática       | Smart Bins agrupam por metadados.                      | Filtrar por partida, evento, período, status e confiança.                        |
| Caminhos rápido e avançado   | Cut e Edit atendem ritmos diferentes.                  | Mostrar ações essenciais e revelar ajuste fino sob demanda.                      |
| Páginas podem desorientar    | Media, Cut, Edit e Deliver distribuem o trabalho.      | Manter etapas visíveis e indicar a etapa atual.                                  |
| Complexidade e hardware      | Avaliações citam aprendizagem e demanda computacional. | Processar no servidor e omitir controles supérfluos.                             |
| Fila torna espera observável | Deliver separa configuração, fila e renderização.      | Exibir estado por arquivo, permitir retorno, explicar falhas e liberar download. |
...
_Figura 9. Estado inicial do editor. "Carregar" aparece no painel lateral e no centro da área de pré-visualização._
...
_Figura 10. Biblioteca após a importação. Um balão sobre edição por transcrição cobre parte do painel e precisa ser fechado para continuar._
...
_Figura 12. Visão geral da interface para Mac. A imagem oficial identifica a divisão entre biblioteca, navegador, viewer e linha do tempo. Fonte: [Apple, interface do Final Cut Pro](https://support.apple.com/guide/final-cut-pro/final-cut-pro-interface-ver92bd100a/mac)._
...
_Figura 13. História principal em azul, elementos conectados acima e áudio organizado abaixo. Fonte: [Apple, introdução à Magnetic Timeline](https://support.apple.com/guide/final-cut-pro/intro-to-the-magnetic-timeline-verb8fcfc133/mac)._
...
_Figura 14. Busca visual por "climbing stairs". O filtro e o resultado permanecem no navegador e na linha do tempo. Fonte: [Apple, Final Cut Pro](https://www.apple.com/final-cut-pro/)._
...
_Figura 17. Projeto local aberto no Studio. O editor concentra prévia, propriedades, faixa de vídeo e zoom na mesma janela._
...
_Figura 18. Painel com três clipes. Os dois últimos usam a mesma filmagem de parque do teste do CapCut._

![Editor do Cap com moldura de navegador aplicada](../assets/02_concorrencia/cap-so/03-editor-com-moldura-anotado.png)

_Figura 19. Moldura de navegador aplicada por um menu de presets. A mudança aparece imediatamente no player._

![Painel de configuração do cursor no Cap Studio](../assets/02_concorrencia/cap-so/04-controles-do-cursor-anotado.png)

_Figura 20. Controles do cursor com tipo, tamanho, inclinação e suavização de movimento._

![Faixa de zoom do Cap com segmento automático de duas vezes](../assets/02_concorrencia/cap-so/05-zoom-automatico-anotado.png)

_Figura 21. Segmento "Automatic Zoom" de 2x gerado a partir dos dados de clique da captura._
...
_Figura 22. Exportação com prévia, destino, formato, resolução, taxa de quadros, tamanho e tempo estimados._
...
**Tipo:** concorrente direto parcial
**Link oficial:** [Página da plataforma](https://wsc-sports.com/platform/)  
**Data de acesso:** 02/09/2026

#### Contexto e proposta

A WSC Sports anuncia uma plataforma de IA para analisar eventos esportivos, criar vídeos e gerenciar conteúdo. A solução abrange produção ao vivo, edição e publicação, enquanto nosso recorte trata apenas da pós-produção de partidas gravadas. Por isso, esta análise usa como referência apenas os padrões transferíveis de seleção, revisão e organização de mídia.

#### Funcionalidades relevantes

| Funcionalidade                              | Como é realizada                                                                                                                                                                                                           | Evidência/print                                                                  | Observação de IHC                                                                                                                                                                                                                                                                       |
| ------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Identificar e classificar objetos em vídeos | A imagem promocional mostra objetos identificados por um algoritmo de visão computacional. | ![Detecção de objetos](../assets/02_concorrencia/wsc-sports/wsc_objects.jpeg) | Caixas delimitadoras, etiquetas e uma lista relacionam cada detecção ao vídeo. A imagem não mostra como a análise é configurada nem como erros são tratados. |
| Criação automática de vídeos | A demonstração mostra cenas selecionadas e uma ação "Create Video" que produz vídeos. | ![Criar vídeos](../assets/02_concorrencia/wsc-sports/wsc_create.jpeg) | A seleção e a ação de criação aparecem na mesma tela. O material não permite medir quantas etapas existem nem a facilidade de uso. |
| Estúdio de edição de vídeos | A plataforma anuncia controles para vídeo, áudio, legendas e gráficos, com prévia e publicação. | ![Estúdio de edição](../assets/02_concorrencia/wsc-sports/wsc_studio.jpeg) | A tela usa player e faixas separadas por tipo de conteúdo, padrões também vistos em editores não lineares. A edição e a publicação ficam fora do nosso recorte. |
| Pesquisa de conteúdo existente | A demonstração apresenta busca e classificação de mídias armazenadas. | ![Gerenciamento de vídeos](../assets/02_concorrencia/wsc-sports/wsc_manage.jpeg) | A tela mostra campo de busca, categorias e resultados visuais. Não há evidência sobre volume, desempenho ou recuperação quando a busca falha. |
| Monitoramento do conteúdo publicado | A demonstração apresenta visualizações, compartilhamentos, instalações e receita estimada junto a uma prévia do vídeo. | ![Monitoramento](../assets/02_concorrencia/wsc-sports/wsc_engage.jpeg) | Os indicadores têm rótulos e valores visíveis. Essas métricas tratam da publicação em redes sociais e não integram o escopo atual. |

#### Experiência do usuário e opiniões

A [página de clientes da WSC Sports](https://wsc-sports.com/clients/) reúne depoimentos sobre confiabilidade, personalização, produção em escala e distribuição em tempo real. Os relatos foram escolhidos pelo fornecedor e ajudam a identificar o contexto comercial da plataforma. Eles não comprovam facilidade de uso, acessibilidade ou adequação ao editor definido neste projeto.

#### Padrões e tendências percebidos

As imagens promocionais mostram dois grupos de padrões. Busca, categorias e cartões organizam o acervo como em uma aplicação web. No estúdio, player, fundo escuro e faixas separadas organizam vídeo, áudio, legendas e gráficos. Como não houve acesso ao produto, não foi possível observar navegação completa, estados de erro ou uso por teclado.

#### Pontos positivos, limitações e lições

| Ponto                                                                                                                                                                                         | Evidência                                                                                                                          | Implicação para nosso projeto                                                                                                                                                                                                                                                                                                                                      |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Relação visual entre mídia e resultado | As demonstrações colocam player, cenas selecionadas e ação de criação próximos. | Manter cada melhor momento ligado ao vídeo de origem e permitir conferência antes do download. |
| Cobertura ampla do fluxo comercial | O material anuncia análise, criação, edição, gestão e acompanhamento de conteúdo. | Usar apenas os padrões ligados à seleção e revisão. Edição, publicação e métricas sociais permanecem fora do escopo. |
| Acesso limitado ao produto | A análise se restringe a textos e imagens promocionais; não houve teste da interface. | Tratar os achados como referências exploratórias, sem afirmar facilidade, eficiência ou adoção pelo público do projeto. |
...
A Magnifi anuncia recursos de IA para identificar melhores momentos, editar vídeos, gerar legendas e preparar conteúdo para redes sociais. Parte das demonstrações trata de produção ao vivo e publicação, atividades que ficam fora do nosso recorte. A análise considera apenas os elementos que podem informar a revisão de resultados na pós-produção.

#### Funcionalidades relevantes

| Funcionalidade                                           | Como é realizada                                                                                                                                                                                                | Evidência/print                                                                 | Observação de IHC                                                                                                                                                                                                                                                                                                              |
| -------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Identificação e classificação de objetos | A demonstração mostra objetos detectados sobre o vídeo. | ![Detecção de objetos](../assets/02_concorrencia/magnifi/magnifi_objects.jpeg) | Caixas delimitadoras e etiquetas relacionam as detecções ao conteúdo. A imagem não mostra configuração, correção ou tratamento de erro. |
| Criação automática de vídeos | A demonstração apresenta vídeos selecionados e uma ação "Create" para formar uma compilação. | ![Criação de vídeos](../assets/02_concorrencia/magnifi/magnifi_highlights.jpeg) | Seleção, miniaturas e criação aparecem no mesmo fluxo. Não é possível concluir quantas etapas ou decisões o uso real exige. |
| Gerenciamento por regras | A demonstração apresenta condições de esporte, evento e destino para automatizar ações. | ![Regras](../assets/02_concorrencia/magnifi/magnifi_rules.jpeg) | Os campos tornam a regra visível antes da execução. A publicação automática está fora do escopo e exigiria prevenção e recuperação de erros. |
| Publicação em redes sociais | A plataforma anuncia geração de miniatura, legenda, localização e publicação. | ![Social](../assets/02_concorrencia/magnifi/magnifi_social.jpeg) | A tela permite conferir elementos antes da aprovação, mas a publicação não faz parte do fluxo deste projeto. |
| Geração de legendas | A demonstração mostra seleção de idioma, player e faixas temporais. | ![Legendas](../assets/02_concorrencia/magnifi/magnifi_subtitles.jpeg) | Player, faixas e controles próximos preservam o contexto temporal. A imagem não permite avaliar acessibilidade ou facilidade de uso. |

#### Experiência do usuário e opiniões

A [página institucional da Magnifi](https://www.magnifi.ai/about-us) reúne depoimentos de clientes sobre redução de edição manual, processamento de partidas, geração automática de melhores momentos e publicação frequente. Esses relatos ajudam a identificar atividades e pressões do domínio. Como foram selecionados pelo fornecedor, não comprovam usabilidade, acessibilidade nem desempenho para o público deste projeto.

#### Padrões e tendências percebidos

As imagens promocionais mostram cartões, miniaturas, botões de ação e formulários de regras. O editor de legendas usa player e faixas separadas por conteúdo. Esses elementos descrevem a organização visual, mas não demonstram rapidez, facilidade de aprendizado ou recuperação de falhas.

#### Pontos positivos, limitações e lições

| Ponto                                                                                                                                                                                                                                                                         | Evidência                                                                                                                       | Implicação para nosso projeto                                                                                                                                                                                                                                                                                                                                   |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Seleção visível antes da criação | As demonstrações colocam miniaturas, opções e a ação "Create" no mesmo contexto. | Mostrar quais cortes estão selecionados antes de preparar o download. |
| Regras explicitam condições e destino | A imagem de automação apresenta os componentes da regra antes de executá-la. | Se regras forem estudadas no futuro, mostrar condições e consequências. A função não entra no recorte atual. |
| Acesso limitado ao produto | A análise se restringe a textos, imagens e depoimentos promocionais. | Tratar os achados como referências exploratórias, sem afirmar facilidade, eficiência ou adoção pelo público do projeto. |

## 3. Ferramentas cotidianas presumidas
...
| CapCut             | Realizar edições e exportações de vídeo                                          | Player, miniaturas, linha do tempo e exportação                                                                                                                                                                     | Figuras 9 a 11                                             | Manter as tarefas principais acessíveis e reduzir a complexidade da interface                                               |
| Final Cut Pro      | Organizar, editar e exportar vídeos                                              | Player, biblioteca de mídia, marcadores, linha do tempo e exportação                                                                                                                                                | Figuras 12 a 16                                            | Facilitar a localização, seleção e manipulação de trechos                                                                   |
| cap.so             | Editar e apresentar vídeos                                                       | Player, pré-visualização e exportação                                                                                                                                                                               | Figuras 17 a 22                                            | Oferecer pré-visualização clara antes de baixar ou exportar resultados                                                      |
> A análise confirma que esses padrões existem nos editores estudados. A familiaridade do público com as ferramentas e a terminologia ainda deve ser validada, conforme H17 e H19.

### 3.1 Alternativas de mercado

WSC Sports e Magnifi são alternativas comerciais, não ferramentas cujo uso cotidiano pelo público escolhido tenha sido demonstrado.

| Produto | Atividades anunciadas | Padrões observados | Evidências | Limite da análise |
|---|---|---|---|---|
| WSC Sports | Análise, criação, edição, gestão e distribuição de conteúdo esportivo | Busca, cartões de mídia, player e faixas de edição | [Figuras WSC Sports](../assets/02_concorrencia/wsc-sports) | Material promocional; inclui produção ao vivo e publicação |
| Magnifi | Identificação de momentos, criação de vídeos, regras, legendas e publicação | Miniaturas, formulários de regras, player e faixas temporais | [Figuras Magnifi](../assets/02_concorrencia/magnifi) | Material promocional; inclui produção ao vivo e publicação |

## 3.2 Padrões de interface relevantes ao escopo de IHC
...
As conclusões sobre C06 e C07 se baseiam em materiais promocionais. Não foi possível testar os produtos nem observar estados de erro, acessibilidade ou tempo de execução.

| Critério                      | C01                                                                                                                                                                       | C02                                                                                                                                                       | C03                                                                                                                                                                              | C04                                                                                                                                                               | C05                                                                                                                                                                                                        | C06                                                                                                                                                                       | C07                                                                                                                                                                           | Oportunidade para o projeto                                                                                                                                                                                   |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Navegação                     | Biblioteca, monitores e linha do tempo mantêm fonte e resultado próximos. Painéis configuráveis atendem especialistas, mas aumentam a carga inicial.                      | As páginas separam mídia, corte, edição e entrega. A divisão organiza o fluxo, embora possa desorientar quem não sabe em qual página agir.                | O estado vazio indica como carregar arquivos. Biblioteca, player, propriedades e linha do tempo seguem uma disposição conhecida, mas concentram muitos controles.                | A posição dos painéis é previsível e a triagem fica separada da montagem. A hierarquia de bibliotecas, eventos e projetos cobra aprendizado.                      | O fluxo é visual e usa player, propriedades e linha do tempo. As decisões ficam espalhadas entre seletor, painel de clipes e exportação.                                                                   | A busca e a gestão de mídia seguem a organização de aplicações web. O estúdio usa player e faixas de edição.                                                    | As demonstrações mostram seleção direta de vídeos, configuração de regras e ações de criação.                                                                          | Dividir o fluxo em quatro etapas: enviar, acompanhar, revisar resultados e baixar. Durante a revisão, exibir na mesma tela a lista de cortes, o player e o instante correspondente da partida.                             |
| Feedback/estado               | Player, playhead, timecode e atualização da linha do tempo mostram o efeito das ações. A exportação resume o resultado.                                                   | A linha do tempo dupla conserva contexto global e detalhe. A fila de renderização expõe andamento de trabalhos demorados.                                 | Os estados "Adicionado" e "Carregando...", a duração e a atualização do player confirmam importação e montagem.                                                                  | Tarefas em segundo plano mostram percentuais e podem ficar em fila, pausar ou retomar. O andamento fica em uma janela própria.                                    | Prévia, medidor de áudio, contagem de clipes e duração total respondem às ações. A exportação estima tamanho e tempo.                                                                                      | A prévia em tempo real permite conferir os vídeos gerados. Indicadores mostram o desempenho do conteúdo publicado.                                              | A prévia permite conferir os vídeos gerados antes da publicação.                                                                                                      | Mostrar o estado de cada arquivo com rótulos como "enviando", "aguardando", "processando", "pronto" e "erro". Informar a etapa atual e mostrar uma porcentagem somente quando o sistema puder calculá-la. |
| Prevenção/recuperação de erro | A prévia, o timecode e o resumo de exportação permitem conferir o corte. Ajustes têm resposta imediata, mas os vários modos de edição podem produzir efeitos inesperados. | As visões global e detalhada reduzem a perda de posição. Caminhos rápido e avançado oferecem controle, mas a análise não documenta recuperação de falhas. | Miniaturas e prévia ajudam a conferir o conteúdo antes da exportação. Controles densos, nomes cortados e interrupções promocionais favorecem enganos.                            | A Magnetic Timeline evita lacunas e mantém elementos conectados, mas pode deslocá-los de modo inesperado. A prévia e o resumo de exportação apoiam a conferência. | Prévia e medidor evitam capturas erradas; arquivos podem ser acrescentados depois. No teste, a validação técnica aprovou um arquivo diferente do esperado.                                              | O usuário seleciona cenas antes de criar vídeos e pode conferir a prévia.                                                                                              | O usuário seleciona e confere os elementos antes de criar ou publicar.                                                                                                      | Confirmar visualmente o arquivo antes do processamento e manter cada corte ligado ao original. Permitir ajustar limites, desfazer, substituir arquivos e retomar tarefas interrompidas sem perder o trabalho. |
| Terminologia                  | Usa conceitos profissionais como sequência, pistas, Razor e tipos de trim. São precisos para especialistas, mas excessivos para uma consulta de melhores momentos.        | Termos como Media, Cut, Edit, Deliver, bins e trims refletem a edição profissional e exigem que o usuário aprenda a estrutura do programa.                | "Carregar" e "Exportar" são claros. Parte das ações depende de ícones e termos genéricos de edição.                                                                              | Biblioteca, evento, projeto, papéis e Magnetic Timeline pertencem ao vocabulário do aplicativo, não ao futebol.                                                   | "Clips" e "Export" convivem com BPP, tensão, atrito e massa. "Instant" e "Studio" não explicam quando os dados são enviados.                                                                               | "Create Video", busca por mídia e métricas de desempenho correspondem às tarefas mostradas.                                                                    | As prévias usam rótulos curtos, como "Create", e categorias para organizar regras.                                                                                         | Usar "partida", "vídeo enviado", "melhor momento", "gol", "início", "fim", "duração" e "baixar cortes". Se o sistema mostrar uma porcentagem de confiança, explicar que ela representa a estimativa da IA para aquela detecção. Informar também se o vídeo ainda está sendo processado e por quanto tempo o arquivo ficará armazenado. |
| Acessibilidade                | Não foi testada. A densidade de painéis, ícones e modos indica a necessidade de verificar teclado, foco, contraste e nomes acessíveis.                                    | Não foi testada. Muitos painéis e controles compactos podem dificultar navegação e leitura.                                                               | Vários controles e itens da linha do tempo não têm nomes úteis na árvore de acessibilidade. O arraste precisa de alternativa por teclado.                                        | Não foi possível testar VoiceOver ou teclado. Há muitos ícones compactos e uso de cor para distinguir papéis.                                                     | Botões, campos e controles deslizantes têm nomes úteis, mas alguns ícones principais e elementos da linha do tempo continuam sem rótulo.                                                                   | As imagens mostram caixas e etiquetas com contraste.                                                                                                                   | As prévias mostram botões visíveis e usam cores e animações para comunicar informações.                                                                                      | Permitir que o usuário envie um vídeo, revise um corte e faça o download usando apenas o teclado. Todos os controles devem ter nome acessível e foco visível. Estados como "processando", "pronto" e "erro" precisam aparecer em texto, não apenas por cor ou animação. |
| Eficiência                    | Oferece atalhos, marcadores e controle preciso, mas a localização e o corte continuam manuais e exigem domínio do editor.                                                 | Source Tape, Smart Bins, linha do tempo dupla e fila reduzem abertura de clipes, perda de contexto e espera bloqueante.                                   | O carregamento inicial é rápido de entender e os controles contextuais evitam telas extras. A interface completa e problemas relatados com vídeos longos podem atrasar a tarefa. | Busca visual e por transcrição, favoritos e tarefas em segundo plano encurtam a triagem. A montagem profissional ainda traz funções além do necessário.           | Presets e zoom automático reduzem ajustes manuais, e a exportação antecipa o custo. A dispersão das decisões e os problemas de estabilidade reduzem o ganho.                                               | A automação reúne análise, criação, edição, gestão e acompanhamento de conteúdo.                                                                                         | Automatiza identificação, montagem, legendas, regras e publicação.                                                                                                                | Automatizar a detecção e a preparação dos cortes, mas preservar revisão humana. Oferecer filtros, navegação sequencial e download em lote sem reproduzir um editor completo.                                  |
...
As fontes específicas estão ligadas junto às afirmações e figuras de cada análise. As principais categorias consultadas foram:

- páginas e documentação oficiais de [Adobe Premiere](https://www.adobe.com/br/products/premiere.html), [DaVinci Resolve](https://www.blackmagicdesign.com/products/davinciresolve), [CapCut](https://www.capcut.com/), [Final Cut Pro](https://www.apple.com/final-cut-pro/), [Cap](https://cap.so/), [WSC Sports](https://wsc-sports.com/platform/) e [Magnifi](https://www.magnifi.ai/product);
- avaliações independentes do Premiere Pro, DaVinci Resolve e Final Cut Pro publicadas pelo TechRadar;
- avaliações de usuários nas lojas de aplicativos, G2 e Reddit, identificadas nas análises correspondentes;
- documentação e relatos de problemas do Cap no GitHub, ligados na análise C05;
- depoimentos institucionais de clientes da WSC Sports e da Magnifi, usados apenas para caracterizar o contexto comercial.
...
- [x] Opiniões de UX têm fonte e os materiais promocionais estão identificados como limitação.
